      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-sm text-purple-300 mb-6">
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-8 max-w-xl mx-auto lg:mx-0">
              ...
              <br />
              <span className="text-white font-medium">Unifié avec Google Workspace.</span>
            </p>
            ...
            {/* Trust badges */}
            <div className="flex flex-wrap items-center gap-6 mt-10 justify-center lg:justify-start text-sm text-gray-400">
            ...
            <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-slate-800/50 border-b border-white/10">
                ...
                <div className="flex-1 flex justify-center">
                  <div className="px-4 py-1 bg-slate-700/50 rounded-lg text-xs text-gray-400">
                    radarapp.fr/today
                  </div>
                </div>
              </div>
              ...
              <div className="aspect-[16/10] bg-gradient-to-br from-slate-800 to-slate-900 p-6">
                {/* Mock Dashboard */}
                  ...
                  <div className="flex-1 grid grid-cols-3 gap-4">
                    ...
                    <div className="col-span-1 space-y-2">
                      {[...Array(6)].map((_, i) => (
                        <div
                          key={i}
                          className={`h-8 rounded-lg ${i === 0 ? "bg-purple-500/30" : "bg-white/5"}`}
                        />
                      ))}
                    </div>
                    ...
                    <div className="col-span-2 space-y-3">
                      ...
                      <div className="grid grid-cols-4 gap-2">
                        {[...Array(4)].map((_, i) => (
                          <div key={i} className="h-16 bg-white/5 rounded-lg p-2">
                            <div className="h-3 w-8 bg-white/20 rounded mb-2" />
                            <div className="h-6 w-12 bg-purple-500/30 rounded" />
                          </div>
                        ))}
                      </div>
                        ...
                        {[...Array(5)].map((_, i) => (
                          <div key={i} className="space-y-2">
                            ...
                            {[...Array(3)].map((_, j) => (
                              <div
                                key={j}
                                className="h-12 bg-white/5 rounded-lg border border-white/10"
                              />
                            ))}
                          </div>
                        ))}
